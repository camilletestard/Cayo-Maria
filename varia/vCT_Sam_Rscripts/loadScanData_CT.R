...
#rm(list = ls())# clear all variables
      ...
      # 1. Load and clean data
          ...
          names(A1)=column_names #rename columns
              ...
              #A1 s used as input for Permuted networks and generating sociality network metrics.
        ...
        behav$rc     <- behavIMP$ximp$rc
            ...
            #A2 is used as input for the modelling sociality rates 
        ...
        # summarizing bins (creating the A3 file). Here Sam is taking a representative sub-sample of the whole sample. 
            A3 <-
              ...
              dplyr::summarise(focalID    = first(focalID)    , #summarize: gives given output separately for each bin (i.e. id/group/Q...); first: extract the first value from a vector
