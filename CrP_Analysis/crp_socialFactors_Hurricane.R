...
rslt <- read.csv("CrP_Analysis/CrP_raw_results/liver_results.csv")
...
crpLevel2 <- glmmTMB(crp_level ~ isFemale + age + days_between + isPost*rank + (1|plaque_num) + (1|id),
