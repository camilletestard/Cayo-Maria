...
for (i in 1:iter) {
  ...
  summary(isNotAlone)
  # test <- glmer(isProx~ isPost + (1|focalID) + (1|year), data = ExSubScans, family = binomial); summary(test)
  ...
  save.image("C:/Users/Camille Testard/Documents/GitHub/Cayo-Maria/Social_Network_Analysis/ModelEffectsFinal2.RData")
