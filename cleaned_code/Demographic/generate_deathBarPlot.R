...
years=c(2016,2016,2016,2017,2017,2017,2017,2017,2017,2017,2017,2017,2017,2017,2017,
        2018,2018,2018,2018,2018,2018,2018,2018,2018,2018)
months=c(10,11,12,01,02,03,04,05,06,07,08,09,10,11,12,01,02,03,04,05,06,07,08,09,10)
...
death.df=data.frame(month=c("oct.16","nov.16","dec.16","jan.17","fev.17","mar.17","avr.17","mai.17","jun.17","jul.17","aug.17",
                 "sept.17","oct.17","nov.17","dec.17","jan.18","fev.18","mar.18","avr.18","mai.18","jun.18","jul.18","aug.18","sep.18","oct.18"),
...
death.plot<-ggplot(data=death.df, aes(x=month, y=death)) +
  ...
  geom_vline(xintercept=12.5, linetype=1, color='red', size=2)+
  geom_vline(xintercept=3.5, linetype=2, color='grey', size=1)+
  geom_vline(xintercept=15.5, linetype=2, color='grey', size=1)+
  geom_text(x=1.85, y=2.25, label="2016",size=8,color='darkgrey')+ 
  geom_text(x=5.25, y=2.25, label="2017",size=8,color='darkgrey')+
  geom_text(x=17, y=2.25, label="2018",size=8,color='darkgrey')+
  geom_text(x=16.5, y=2.5, label="Hurricane Maria",size=8,color='red')+
