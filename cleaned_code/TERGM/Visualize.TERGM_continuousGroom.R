...
vioplot(TERGMeffects.ALL$form.triangle.close,TERGMeffects.ALL$form.reciprocity,
        ...
        TERGMeffects.ALL$form.homoph.rank,TERGMeffects.ALL$form.homoph.groom,
...
Means = colMeans2(as.matrix(TERGMeffects.ALL[,3:12]), na.rm=T); Means = round(Means,2)
CI = colQuantiles(as.matrix(TERGMeffects.ALL[,3:12]), probs = c(0.025, 0.975), na.rm = TRUE); CI = round(CI,4) #compute mean estimte and 95% CI (2.5 and 97.5 percentiles)
...
boxplot(TERGMeffects.ALL$diss.kinship,TERGMeffects.ALL$diss.prox,TERGMeffects.ALL$diss.homoph.sexF,TERGMeffects.ALL$diss.homoph.sexM,
              ...
              TERGMeffects.ALL$diss.homoph.groom,
              at=c(1,2,3,4,5,6,7),
...
Means = colMeans2(as.matrix(TERGMeffects.ALL[,c(13:20)]), na.rm=T); Means = round(Means,2)
CI = colQuantiles(as.matrix(TERGMeffects.ALL[,c(13:20)]), probs = c(0.025, 0.975), na.rm = TRUE); CI = round(CI,4) #compute mean estimte and 95% CI (2.5 and 97.5 percentiles)
Estimates = cbind(Means,CI); Estimates = as.data.frame(Estimates); colnames(Estimates) = c("Estimate","2.5%","97.5%")
...
##### V #####
TERGMeffects.V[TERGMeffects.V<=-5]=NA
TERGMeffects.V[TERGMeffects.V>=5]=NA
TERGMeffects.V[TERGMeffects.V==-Inf]=NA

#Plot distribution of parameters for bond formation model
tiff("TERGMcoeff.formation.V.tiff", 
     units="in", width=10, height=10, res=300, compression = 'lzw')

boxplot(TERGMeffects.V$form.triangle.close,TERGMeffects.V$form.reciprocity,
        TERGMeffects.V$form.kinship,TERGMeffects.V$form.prox,
        TERGMeffects.V$form.homoph.sexF, TERGMeffects.V$form.homoph.sexM,TERGMeffects.V$form.homoph.age,
        TERGMeffects.V$form.homoph.rank,TERGMeffects.V$form.homoph.groom,
        at=c(1,2,3,4,5,6,7,8,9),
...
dev.off()
# 
# boxplot(TERGMeffects.V$form.homoph.rank,
#         horizontal =T, main="Coefficient from TERGM Formation Model",
#         xlab="coefficient",range=0.9,
#         names=c("rank"))
# segments(0,0,0,10, col = "Red", lty=5, lwd=2, add=T)

Means = colMeans2(as.matrix(TERGMeffects.V[,3:12]), na.rm=T); Means = round(Means,2)
CI = colQuantiles(as.matrix(TERGMeffects.V[,3:12]), probs = c(0.025, 0.975), na.rm = TRUE); CI = round(CI,4) #compute mean estimte and 95% CI (2.5 and 97.5 percentiles)
Estimates = cbind(Means,CI); Estimates = as.data.frame(Estimates); colnames(Estimates) = c("Estimate","2.5%","97.5%")
row.names(Estimates)=c("edges","triad.closure","reciprocity","kin","prox","female","male","age","rank","greg")
t.formation<-tableGrob(Estimates); t.formation<-grid.arrange(t.formation, top="Coefficient from TERGM Formation Model"); #create table, arrange table
...
##### KK #####
TERGMeffects.KK[TERGMeffects.KK<=-5]=NA
TERGMeffects.KK[TERGMeffects.KK>=5]=NA
TERGMeffects.KK[TERGMeffects.KK==-Inf]=NA

#Plot distribution of parameters for bond formation model
tiff("TERGMcoeff.formation.KK.tiff", 
     units="in", width=10, height=10, res=300, compression = 'lzw')

boxplot(TERGMeffects.KK$form.triangle.close,TERGMeffects.KK$form.reciprocity,
        TERGMeffects.KK$form.kinship,TERGMeffects.KK$form.prox,
        TERGMeffects.KK$form.homoph.sexF, TERGMeffects.KK$form.homoph.sexM,TERGMeffects.KK$form.homoph.age,
        TERGMeffects.KK$form.homoph.rank,TERGMeffects.KK$form.homoph.groom,
        at=c(1,2,3,4,5,6,7,8,9),
...
dev.off()
# 
# boxplot(TERGMeffects.KK$form.homoph.rank,
#         horizontal =T, main="Coefficient from TERGM Formation Model",
#         xlab="coefficient",range=0.9,
#         names=c("rank"))
# segments(0,0,0,10, col = "Red", lty=5, lwd=2, add=T)

Means = colMeans2(as.matrix(TERGMeffects.KK[,3:12]), na.rm=T); Means = round(Means,2)
CI = colQuantiles(as.matrix(TERGMeffects.KK[,3:12]), probs = c(0.025, 0.975), na.rm = TRUE); CI = round(CI,4) #compute mean estimte and 95% CI (2.5 and 97.5 percentiles)
Estimates = cbind(Means,CI); Estimates = as.data.frame(Estimates); colnames(Estimates) = c("Estimate","2.5%","97.5%")
row.names(Estimates)=c("edges","triad.closure","reciprocity","kin","prox","female","male","age","rank","greg")
t.formation<-tableGrob(Estimates); t.formation<-grid.arrange(t.formation, top="Coefficient from TERGM Formation Model"); #create table, arrange table
